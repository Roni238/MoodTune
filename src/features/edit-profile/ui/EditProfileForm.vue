  ...
  <div class="edit-profile">
    ...
    <form @submit.prevent="updateProfile" class="edit-form">
      ...
      <div class="edit-form__actions">
        ...
        <AppButton @click="deleteUserData" variant="secondary" :loading="isLoading">
          Очистить информацию о себе
        </AppButton>
        <LogoutButton />
      </div>
    </form>
...
const { profile, isLoading, isFormValid, updateProfile, deleteUserData } = useEditProfile()
</script>
